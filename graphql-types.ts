...
export type MeQuery = { file?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> };

export type ProjectsQueryVariables = Exact<{ [key: string]: never; }>;


export type ProjectsQuery = { allMdx: { edges: Array<{ node: (
        Pick<Mdx, 'body'>
        & { frontmatter?: Maybe<(
          Pick<MdxFrontmatter, 'id' | 'title' | 'tags' | 'website' | 'github'>
